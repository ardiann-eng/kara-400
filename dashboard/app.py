    ...
    try:
        ...
        for s in signals:
            ...
            result.append({
                ...
                "side":       s.side.value,
                "score":      s.score,
                "direction_score": getattr(s.breakdown, "direction_score", 0),
                "trade_quality_score": getattr(s.breakdown, "trade_quality_score", 0),
                "failure_risk_score": getattr(s.breakdown, "failure_risk_score", 0),
